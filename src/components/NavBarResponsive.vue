  ...
  <div class="nav-color">
    ...
    >
      <div class="flex items-center justify-between">
        <router-link
          to="/"
          class="text-xl font-bold text-gray-100 md:text-2xl hover:text-amber-400"
          >SPENCER SEDANO
        </router-link>
        <!-- Mobile menu button -->
      ...
      >
        <li class="text-gray-100 font-bold hover:text-amber-400">
        ...
        <!-- TODO: Adding Blog option -->
        <!-- <li class="text-gray-100 font-bold hover:text-amber-400">
          <router-link to="/blog" @click="closeMenu">BLOG</router-link>
        </li>
 -->
        <li class="list-none">
          <router-link to="/zh" @click="closeMenu">
            <img
              class="h-9"
              src="../assets/worldicon.svg"
